...
lint-py:  ## lint python with ruff
	python -m ruff check pydantic_fsspec
	python -m ruff format --check pydantic_fsspec
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix pydantic_fsspec
	python -m ruff format pydantic_fsspec
...
test:  ## run python tests
	python -m pytest -v pydantic_fsspec/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v pydantic_fsspec/tests --cov=pydantic_fsspec --cov-report term-missing --cov-report xml
